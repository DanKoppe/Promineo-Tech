...
let alphabetArrayR = alphabetArray.reverse();
console.log(alphabetArrayR);

console.log(alphabetArrayR.join(''));
...
myTodoList.push("Walk", "Homework", "Make Dinner",);
console.log(myTodoList);

myTodoList.splice(1,1);
console.log(myTodoList);

var yourTodoList = ["Make Coffee", "Play with Cat",];
console.log(yourTodoList);

var ourTodoList = myTodoList.concat(yourTodoList);
console.log(ourTodoList);

var ourTodoList1 = [...myTodoList, ...yourTodoList];
...
// questions 7 lab:  reversing strings with split method
// When to and when not to use an else statement at the end of a function (practice question 10)
...
return graduates.sort().reverse();

// above is question 19 from Arrays assignment
