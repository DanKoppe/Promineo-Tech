...
let myName = "Dan"
let friendsName = "Ryan"


//Question: Name a reason why you would use const instead of let.
//Answer:  One would you const over let if one didn't want the value to be reassigned at any point in the code. ie. value of PI.
...
console.log(`${myName} and ${friendsName} are having ${food} and ${drink} for lunch.`);
...
//Answer: The error message means the constant of drink was previously assigned and cannot be reassgined later on in the code.
...
const lunchTime = (foodChoice, drinkChoice) => {return `${myName} and ${friendsName} are eating ${foodChoice} and ${drinkChoice} for lunch.`}
console.log(lunchTime('Pizza','Water'));
...
// return `${myName} and ${friendsName} are eating ${foodChoice} and ${drinkChoice} for lunch.`}  
...
console.log(foodForTodayAndTomorrow('Burgers', 'Juice', lunchTime('Pizza', 'Soda',) ))
